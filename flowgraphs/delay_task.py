...
import delay_task_blocks_sub_xx_0 as blocks_sub_xx_0  # embedded python block
import sip
import threading



class delay_task(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Variant B Delay", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Variant B Delay")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "delay_task")
        ...
        self._delay_win = qtgui.RangeWidget(self._delay_range, self.set_delay, "Manual Delay ", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._delay_win)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            20, #size
            samp_rate, #samp_rate
            "Compensated Delay", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.blocks_sub_xx_0 = blocks_sub_xx_0.blk(max_delay=100, training_len=256)
...
def main(top_block_cls=delay_task, options=None):
